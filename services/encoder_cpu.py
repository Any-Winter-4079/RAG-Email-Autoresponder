...
def run_encoder_cpu_batch_document_embedder(variant, batch, encoder):
    ...
    return run_encoder_batch_document_embedder(
        ...
        batch=batch,
        encoder=encoder,
        worker_name="run_encoder_cpu_batch_document_embedder",
    )
...
def run_encoder_cpu_batch_query_embedder_and_qdrant_retriever(query_texts, variant, encoder_name, top_k):
    ...
    return run_encoder_batch_query_embedder_and_qdrant_retriever(
        ...
        top_k=top_k,
        worker_name="run_encoder_cpu_batch_query_embedder_and_qdrant_retriever",
    )
