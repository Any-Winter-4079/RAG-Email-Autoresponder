...
from config.fine_tune import (
    ...
    M3_FINETUNE_NEGATIVE_SAMPLING_MODE,
...
def main():
    ...
    intermediate_rows, finetune_rows = build_finetune_rows(
        ...
        negative_source_to_weight=M3_FINETUNE_NEGATIVE_SOURCE_TO_WEIGHT,
        negative_sampling_mode=M3_FINETUNE_NEGATIVE_SAMPLING_MODE,
    ...
    print(
        ...
        f"\tnegative source weights: {M3_FINETUNE_NEGATIVE_SOURCE_TO_WEIGHT}\n"
        f"\tnegative sampling mode: {M3_FINETUNE_NEGATIVE_SAMPLING_MODE}\n"
